  ...
  return ((dispatch, getState) => {
    ...
    if (!found) {
      firebase.firestore()
        ...
        .then((snapshot) => {
          if (snapshot.exists) {
            console.log("The fetchUserData for snapshot.data() printed as ", snapshot.data())
...
export function fetchUsersFollowingPosts(uid) {
  return ((dispatch, getState) => {
    firebase.firestore()
      ...
      .get()
      .then((snapshot) => {
        console.log('the snapshot docs for fetchUsersFollowingPosts printed as ', snapshot)
...
export function fetchUsersFollowingLikes(uid, PostId) {
  return ((dispatch, getState) => {
    firebase.firestore()
      ...
      .doc(firebase.auth().currentUser.uid)
      .onSnapshot((snapshot) => {
        console.log('the snapshot docs for fetchUsersFollowingLikes printed as ', snapshot)
